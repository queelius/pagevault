...
# Script activation infrastructure — plain string (no f-string interpolation needed).
# Extracted from the main IIFE so the JS is readable without doubled braces.
# Handles re-executing <script> tags after innerHTML injection, shimming
# DOMContentLoaded/load events, and suppressing document.write().
_ACTIVATION_JS = """\
